---
title: Armor Quick Reference
description: Complete armor table with AC, requirements, and costs
---
...
*5 Minutes to Don, 1 Minute to Doff*
...
*10 Minutes to Don, 5 Minutes to Doff*
...
| Item | Armor Class (AC) | Strength | Stealth | Weight | Cost |
|------|------------------|----------|---------|--------|------|
| Shield | +2 | — | — | 6 lb. | 10 GP |
