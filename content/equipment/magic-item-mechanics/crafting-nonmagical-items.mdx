...
description: Rules for crafting mundane equipment
---
...
The Tools section lists which tools are required to make certain items. The GM assigns required tools for items not listed there.
