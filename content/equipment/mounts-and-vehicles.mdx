...
Barding is armor designed for a mount. Any type of armor on the Armor table can be purchased as barding. The cost is four times the normal cost, and it weighs twice as much.
...
A ship larger than a Keelboat or Rowboat needs a crew of skilled hirelings (see "Hirelings") to function. The minimum number of skilled hirelings needed to crew a ship depends on the type of ship, as shown in the table.
