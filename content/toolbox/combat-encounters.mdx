...
description: Guidelines for building and balancing combat encounters
---
...
### Many Creatures
The more creatures in an encounter, the higher the risk that a series of fortunate die rolls on their part could be devastating to the characters. If you want to include many creatures in an encounter, include some weaker creatures that can be defeated quickly.
