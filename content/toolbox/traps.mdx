---
title: Traps
description: Rules for designing and running traps
---
...
**At Higher Levels.** You can scale the trap for higher levels by increasing the damage and the save DC:
...
**At Higher Levels.** You can scale the trap for higher levels by increasing the damage and the area of effect:
...
**At Higher Levels.** You can scale the trap for higher levels by increasing the pit's depth and damage:
