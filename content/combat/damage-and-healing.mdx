...
description: Hit points, damage types, resistance, vulnerability, and recovery
---
...
See "Equipment" for weapons' damage dice and "Spells" for spells' damage dice.
...
If your character dies, others might find a magical way to revive your character, such as with the Raise Dead spell. Or talk with the GM about making a new character to join the group. The Rules Glossary has more information on being dead.
