---
title: Actions
description: Actions, bonus actions, and reactions—what you can do on your turn
---
...
The game uses actions to govern how much you can do at one time. You can take only one action at a time. This principle is most important in combat, where actions are taken in turns.

Actions can come up outside combat too. When two or more characters want to do something significant at the same time, the Game Master may determine the timing by asking each character involved to make an ability check. In such cases, the character with the highest result goes first.
...
Certain special abilities, spells, and situations allow you to take a special action called a Reaction. A Reaction is an instant response to a trigger of some kind, which can occur on your turn or on someone else's. The Opportunity Attack, described later in "Combat," is the most common type of Reaction.
